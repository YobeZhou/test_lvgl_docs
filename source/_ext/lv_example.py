...
class LvExample(Directive):
    ...
    def run(self):
        ...
        if self.arguments[2] == 'py':
            ...
            paragraph_node = nodes.raw(text=f"<iframe class='lv-example' src='https://docs.lvgl.io/{env.config.version}/_static/built_lv_examples?example={example_name}&w=320&h=240'></iframe>", format='html')
        ...
        example_file = os.path.abspath("source/examples/" + example_path + "." + self.arguments[2])
